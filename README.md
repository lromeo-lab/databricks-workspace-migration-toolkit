...
source normal folder(s)
  ...
  -> git add / commit / push  (main) remote Git repository
...
Clone this repository to your laptop and to the terminal of your source and destination Databricks workspaces.
...
#   <source folder>   <path inside repo>
